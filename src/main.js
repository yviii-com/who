...
export default {
    ...
    'f,f,f,xb,s':['再从祖父'],
    'f,f,f,xb,s,w':['再从祖母'],
    'f,f,f,f,xb,s,s':['三从祖父','族祖父'],
    'f,f,f,f,xb,s,s,w':['三从祖母','族祖母'],
    // 父辈
    ...
    'f,f,f,xb,s,s':['再从父'],
    'f,f,f,xb,s,s,w':['再从母'],
    'f,f,f,f,xb,s,s,s':['三从父','族父'],
    'f,f,f,f,xb,s,s,s,w':['三从母','族母'],
    'f,os':['大姑','大姑妈','姑姊'],
    ...
    'f,xb,d,d,h':['堂外甥女婿'],
    'f,f,xb,s,s,s':['三从子','族子'],
    'f,f,xb,s,s,s,s':['三从孙','族孙'],
    'f,f,xb,s,s,s,s,s':['三曾孙','族曾孙'],
    'f,f,xb,s,s,s,s,s,s':['三玄孙','族玄孙'],
    'f,f,f,xb,s,s,s,s':['四从子','族子'],
    'f,f,f,xb,s,s,s,s,s':['四从孙','族孙'],
    'f,f,f,xb,s,s,s,s,s,s':['四曾孙','族曾孙'],
    'f,f,f,xb,s,s,s,s,s,s,s':['四玄孙','族玄孙'],
    // 子辈
