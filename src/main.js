...
export default {
    ...
    'm,f':['外公','外祖父','姥爷','阿公','外爷','客公','毑父','毑公','姥公','舅家爷','嘎公','尕公','毑爹','外大父','毑爷'],
    'm,m':['外婆','外祖母','姥姥','阿婆','外奶','客婆','毑母','毑婆','姥婆','舅家婆','嘎嘎','尕婆','毑毑','外大母','姥娘','阿嬷','阿嫲','嫲嫲','好婆','嫏嫏','嫏娘'],
    ...
    'h,m,xs':['姨婆母','姨婆','姨婆婆'],
    'h,m,xs,h':['姨公父','姨公','姨公公'],
    'h':['老公','丈夫','先生','夫','男人','新郎','爱爷','夫君','官人','汉子','老头子','郎君','相公','夫婿','良人','老公仔','爱人','老伴','那口子','配偶','伴侣','伉俪','卿卿'],
    ...
    'w':['老婆','妻子','媳妇','媳妇儿','太太','妻','女人','新娘','爱姥','娘子','新娘子','夫人','婆娘','老太婆','内人','内子','内助','贤内助','爱妻','发妻','婆子','老婆子','老婆儿','老婆仔','堂客','爱人','老伴','那口子','配偶','伴侣','伉俪','卿卿'],
    ...
    '1,f,xb,s,s,s':['再从孙'],
    '1,f,xb,s,s,s,s':['再曾孙'],
    '1,f,xb,s,s,s,s,s':['再玄孙'],
    '1,f,f,xb':['从祖父'],
    '1,f,f,xb,w':['从祖母'],
    '1,f,f,xb,s':['从父'],
    '1,f,f,xb,s,w':['从母'],
    '1,f,f,xb,s,s&o':['再从兄'],
    '1,f,f,xb,s,s&o,w':['再从兄妇'],
    '1,f,f,xb,s,s&l':['再从弟'],
    '1,f,f,xb,s,s&l,w':['再从弟妇'],
    '1,f,f,xb,s,s,s':['三从子','族子'],
    '1,f,f,xb,s,s,s,s':['三从孙','族孙'],
    '1,f,f,xb,s,s,s,s,s':['三曾孙','族曾孙'],
    '1,f,f,xb,s,s,s,s,s,s':['三玄孙','族玄孙'],
    '1,f,f,f,xb':['从曾祖父'],
    '1,f,f,f,xb,w':['从曾祖母'],
    '1,f,f,f,xb,s':['再从祖父'],
    '1,f,f,f,xb,s,w':['再从祖母'],
    '1,f,f,f,xb,s,s':['再从父'],
    '1,f,f,f,xb,s,s,w':['再从母'],
    '1,f,f,f,xb,s,s,s&o':['三从兄','族兄'],
    '1,f,f,f,xb,s,s,s&o,w':['三从兄妇','族兄妇'],
    '1,f,f,f,xb,s,s,s&l':['三从弟','族弟'],
    '1,f,f,f,xb,s,s,s&l,w':['三从弟妇','族弟妇'],
    '1,f,f,f,xb,s,s,s,s':['四从子','族子'],
    '1,f,f,f,xb,s,s,s,s,s':['四从孙','族孙'],
    '1,f,f,f,xb,s,s,s,s,s,s':['四曾孙','族曾孙'],
    '1,f,f,f,xb,s,s,s,s,s,s,s':['四玄孙','族玄孙'],
    '1,f,f,f,f,xb':['从高祖父'],
    '1,f,f,f,f,xb,w':['从高祖母'],
    '1,f,f,f,f,xb,s':['再从曾祖父'],
    '1,f,f,f,f,xb,s,w':['再从曾祖母'],
    '1,f,f,f,f,xb,s,s':['三从祖父','族祖父'],
    '1,f,f,f,f,xb,s,s,w':['三从祖母','族祖母'],
    '1,f,f,f,f,xb,s,s,s':['三从父','族父'],
    '1,f,f,f,f,xb,s,s,s,w':['三从母','族母'],
    '1,f,f,f,f,xb,s,s,s,s&o':['四从兄','族兄'],
    '1,f,f,f,f,xb,s,s,s,s&o,w':['四从兄妇','族兄妇'],
    '1,f,f,f,f,xb,s,s,s,s&l':['四从弟','族弟'],
    '1,f,f,f,f,xb,s,s,s,s&l,w':['四从弟妇','族弟妇'],
    '0,xb,s':['娘家侄子','娘家侄'],
    '0,xb,s,s':['归孙'],
    '0,xb,d':['娘家侄女'],
    '0,xs,s':['姨甥','姨甥男','从男','从子'],
