...
export default {
    ...
    // 祖父辈
    'f,f':['爷爷','祖父','奶爷','阿爷','阿公','嗲嗲','依爷','爷儿','爷老','爷老子','爷老倌','大父','爷','二世祖'],
    'f,m':['奶奶','祖母','阿奶','阿姆','阿婆','阿嬷','阿嫲','嫲嫲','依奶','婻婻','娭毑','嗯奶','娘姆','媪婆','亲婆','大母','奶'],
    'm,f':['外公','外祖父','姥爷','阿公','客公','外爷','舅家爷','姥公','毑父','毑爹','毑公','毑爷','嘎公','尕公','外大父'],
    'm,m':['外婆','外祖母','姥姥','姥娘','姥婆','阿婆','阿嬷','阿嫲','嫲嫲','外奶','客婆','舅家婆','好婆','姥婆','毑母','毑婆','毑毑','嘎嘎','尕婆','嫏嫏','嫏娘','外大母'],
    'f,f,ob':['伯公','伯祖','伯翁','大爷爷','大嗲','大爷','大公','大伯公','大阿爷'],
    'f,f,ob,w':['伯婆','姆婆','大奶奶'],
    'f,f,lb':['叔公','叔祖','叔翁','晚公','幺爷','细嗲','小爷爷'],
    ...
    'h,m,xs':['姨婆母','姨婆','姨婆婆'],
    'h,m,xs,h':['姨公父','姨公','姨公公'],
    'h':['老公','丈夫','先生','官人','男人','汉子','夫','夫君','郎君','相公','夫婿','良人','老头子','老公仔','爱人','老伴','那口子','配偶','伴侣','伉俪','卿卿'],
    'h,ob':['大伯子','大伯儿','大伯兄','伯子','伯爷子','婿伯'],
    'h,ob,w':['大婶子','大婶儿','大叔兄妇','伯嫂','姒妇','姒姆','大伯嫂','大伯妇','大伯娘','姐妇'],
    'h,lb':['小叔子','小叔儿','小叔弟','叔子'],
