...
export default {
    ...
    'm,m':['外婆','外祖母','姥姥','阿婆','外奶','客婆','毑母','毑婆','姥婆','舅家婆','嘎嘎','嘎婆','嘎嘎婆','嘎奶奶','尕婆','毑娘','毑毑','外大母','姥娘','魏婆','魏奶','简婆','阿嬷','外嬷','嫲嫲','好婆','嫏嫏','嫏娘'],
    ...
    'f,lb,w':['婶婶','叔母','叔妈','叔娘','阿婶','婶儿','仲母','季母','叔妇','依婶','小婶','小娘','小妈','几婶','婶','婶母','婶妈','婶娘','婶子','家婶','婶爹','嬢嬢'],
    'f,xb,s&o':['堂哥','堂老兄'],
    'f,xb,s&o,w':['堂嫂','堂兄嫂'],
    'f,xb,s&l':['堂弟','堂老弟'],
    ...
    'lb,s':['侄子','弟子'],
    'lb,d':['侄女','弟女'],
    'xb,s':['侄子','侄男','侄儿子','侄小子','嫡侄','亲侄','侄儿','侄','侄仔','阿侄','老侄'],
    'xb,s,w':['侄媳妇','侄媳','侄嫂','侄妇'],
