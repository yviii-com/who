...
!function (root, factory) {
	...
	var _data = {
		...
		'f,m,xb,d,s':['从表兄弟'],
		'f,m,xb,d,d':['从表姐妹'],
		'f,m,xs':['祖姨母','姨祖母','姨婆','姨奶奶'],
		'f,m,xs,h':['祖姨父','姨祖父','姨丈公','姨爷爷','姨爷','姨老爷','姨奶爷'],
		...
		'm,m,m,xs,d':['表姨外祖母'],
		'm,m,m,xs,d,h':['表姨外祖父'],
		'm,m,xb':['舅外祖父','外舅公','外舅祖父','舅姥爷','舅外公','舅公','x舅姥爷'],
		...
		'm,ls,h':['小姨父','小姨丈'],
		//婆家
		'h':['老公','丈夫','先生','官人','男人','汉子','夫','夫君','夫婿','爱人','老伴'],
		'h,f':['公公','翁亲'],
		'h,f,f':['祖翁'],
		'h,f,f,ob':['伯祖翁'],
		'h,f,f,ob,w':['伯祖婆'],
		...
		'h,xs,s':['外甥','甥男','甥儿','甥子','外甥儿','外甥子','外甥儿子'],
		'h,xs,s,w':['外甥媳妇'],
		'h,xs,s,s':['外甥孙'],
		'h,xs,s,s,w':['外甥孙媳妇'],
		'h,xs,s,s,s':['外曾甥孙'],
		...
		'h,ls,h':['小姑夫','小姑妹夫'],
		//岳家
		'w':['老婆','妻子','太太','媳妇','夫人','女人','婆娘','妻','内人','娘子','爱人','老伴'],
		...
		'w,xb,d,d':['外侄孙女'],
		'w,xb,d,d,h':['外侄孙女婿'],
		'w,ob':['大舅子','大舅哥','内兄','妻兄','妻舅'],
		'w,ob,w':['舅嫂','大舅妇','大舅媳妇','大妗子','内嫂','妻兄嫂'],
		'w,lb':['小舅子','内弟','妻弟','妻舅'],
		'w,lb,w':['舅弟媳','小舅妇','小舅媳妇','小妗子','妻妹夫'],
		'w,xs,s':['姨甥','妻外甥'],
		'w,xs,s,w':['姨甥媳妇'],
		'w,xs,s,s':['姨甥孙'],
		'w,xs,s,s,w':['姨甥孙媳妇'],
