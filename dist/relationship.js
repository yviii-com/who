...
!function (root, factory) {
	...
	var _data = {
		...
		'f,m,xb,s&l':['舅表叔父','表叔父','表叔'],
		'f,m,xb,s&l,w':['舅表叔母','表叔母','表婶'],
		'f,m,xb,s,s':['从表兄弟'],
		'f,m,xb,s,d':['从表姐妹'],
		'f,m,xb,d':['舅表姑母','表姑','表姑姑'],
		'f,m,xb,d,h':['舅表姑父','表姑丈'],
		'f,m,xb,d,s':['从表兄弟'],
		'f,m,xb,d,d':['从表姐妹'],
		'f,m,xs':['姨婆','姨奶奶','姨祖父'],
		'f,m,xs,h':['姨丈公','姨爷爷','姨祖母','姨爷','姨老爷','姨奶爷'],
		'f,m,xs,s&o':['姨表伯父','表伯','表伯父'],
		'f,m,xs,s&o,w':['姨表伯母','表伯母'],
		'f,m,xs,s&l':['姨表叔父','表叔父','表叔'],
		'f,m,xs,s&l,w':['姨表叔母','表叔母','表婶'],
		'f,m,xs,s,s':['从表兄弟'],
		'f,m,xs,s,d':['从表姐妹'],
		'f,m,xs,d':['姨表姑母','表姑','表姑姑'],
		'f,m,xs,d,h':['姨表姑父','表姑丈'],
		'f,m,xs,d,s':['从表兄弟'],
		'f,m,xs,d,d':['从表姐妹'],
		'f,xb,s&o':['堂哥','堂兄'],
		...
		'm,f,xs,s':['姑表舅父','姑表舅','表舅','表舅父','表舅舅','姑表舅舅'],
		...
		'm,m,xb,s':['舅表舅父','表舅','表舅父','表舅舅','舅表舅舅'],
		'm,m,xb,s,w':['舅表舅母','表舅妈','表舅母'],
		'm,m,xb,s,s':['从表兄弟'],
		'm,m,xb,s,d':['从表姐妹'],
		'm,m,xb,d':['舅表姨母','表姨母','表姨','表姨妈','表阿姨','舅表姨姨'],
		'm,m,xb,d,h':['舅表姨父','表姨父','表姨丈'],
		'm,m,xb,d,s':['从表兄弟'],
		'm,m,xb,d,d':['从表姐妹'],
		'm,m,xs':['外姨婆','外姨祖母','姨姥姥','姨婆'],
		'm,m,xs,h':['外姨丈公','外姨祖父','姨姥爷'],
		'm,m,xs,s':['姨表舅父','表舅','表舅父','表舅舅','姨表舅舅'],
		'm,m,xs,s,w':['姨表舅母','表舅妈','表舅母','表舅舅','姨表舅舅'],
		'm,m,xs,s,s':['从表兄弟'],
		'm,m,xs,s,d':['从表姐妹'],
		'm,m,xs,d':['姨表姨母','表姨','表姨母','表姨妈','表阿姨'],
		'm,m,xs,d,h':['姨表姨父','表姨丈','表姨父'],
		'm,m,xs,d,s':['从表兄弟'],
		'm,m,xs,d,d':['从表姐妹'],
		//舅家
