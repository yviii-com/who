...
!function (root, factory) {
	...
	var _data = {
		...
		'f,f,xs,s,s&o':['姑表叔表兄','从表兄'],
		'f,f,xs,s,s&l':['姑表叔表弟','从表弟'],
		'f,f,xs,s,d&o':['姑表叔表姐妹','从表姐'],
		'f,f,xs,s,d&l':['姑表叔表妹','从表妹'],
		'f,f,xs,d':['姑表姑母','表姑妈','表姑母','表姑姑','表姑'],
		'f,f,xs,d,h':['姑表姑父','表姑爸','表姑父','表姑丈'],
		'f,f,xs,d,s&o':['姑表姑表兄','从表兄'],
		'f,f,xs,d,s&l':['姑表姑表弟','从表弟'],
		'f,f,xs,d,d&o':['姑表姑表姐','从表姐'],
		'f,f,xs,d,d&l':['姑表姑表妹','从表妹'],
		'f,m':['奶奶','祖母','阿嫲','阿嬷','嫲嫲'],
		'f,m,f':['曾外祖父','外太公','太姥爷'],
		...
		'f,m,xb,s,s&o':['舅表叔表兄','从表兄'],
		'f,m,xb,s,s&l':['舅表叔表弟','从表弟'],
		'f,m,xb,s,d&o':['舅表叔表姐','从表姐'],
		'f,m,xb,s,d&l':['舅表叔表妹','从表妹'],
		'f,m,xb,d':['舅表姑母','表姑妈','表姑母','表姑姑','表姑'],
		'f,m,xb,d,h':['舅表姑父','表姑爸','表姑父','表姑丈'],
		'f,m,xb,d,s&o':['舅表姑表兄','从表兄'],
		'f,m,xb,d,s&l':['舅表姑表弟','从表弟'],
		'f,m,xb,d,d&o':['舅表姑表姐','从表姐'],
		'f,m,xb,d,d&l':['舅表姑表妹','从表妹'],
		...
		'f,m,xs,s,s&o':['姨表叔表兄','从表兄'],
		'f,m,xs,s,s&l':['姨表叔表弟','从表弟'],
		'f,m,xs,s,d&o':['姨表叔表姐','从表姐'],
		'f,m,xs,s,d&l':['姨表叔表妹','从表妹'],
		'f,m,xs,d':['姨表姑母','表姑妈','表姑母','表姑姑','表姑','从母姑母'],
		'f,m,xs,d,h':['姨表姑父','表姑爸','表姑父','表姑丈','从母姑父'],
		'f,m,xs,d,s&o':['姨表姑表兄','从表兄'],
		'f,m,xs,d,s&l':['姨表姑表弟','从表弟'],
		'f,m,xs,d,d&o':['姨表姑表姐','从表姐'],
		'f,m,xs,d,d&l':['姨表姑表妹','从表妹'],
		'f,xb,w,f':['姻伯公'],
		'f,xb,w,m':['姻伯婆'],
		'f,xb,w,xb':['姻世伯'],
		'f,xb,w,xb,w':['姻伯母'],
		...
		'f,lb,w':['婶婶','婶母','阿婶','家婶','叔母','叔妈','叔娘','季母','小娘','小妈','x婶','婶'],
		//姑家
		...
		'f,xs,d&l':['姑表妹','表妹'],
		'f,xs,d&l,h':['姑表妹夫','表妹夫'],
		'f,xs,d,s':['表外甥男','表外甥','姑表甥男','表甥男'],
		'f,xs,d,s,s':['表外甥孙男'],
		'f,xs,d,s,d':['表外甥孙女'],
		'f,xs,d,d':['表外甥女','表外甥','姑表甥女','表甥女'],
		'f,xs,xb,d,d,s':['表外甥外孙男'],
		'f,xs,d,d,d':['表外甥外孙女'],
		'f,os':['姑妈','姑母'],
		'f,ls':['姑妈','姑姐'],
		//外家
		...
		'm,f,xs,s,s&o':['姑表舅表兄','从表兄'],
		'm,f,xs,s,s&l':['姑表舅表弟','从表弟'],
		'm,f,xs,s,d&o':['姑表舅表姐','从表姐'],
		'm,f,xs,s,d&l':['姑表舅表妹','从表妹'],
		'm,f,xs,d':['姑表姨母','姑表姨妈','表姨母','表姨妈','表姨','表阿姨','姑表姨姨'],
		'm,f,xs,d,h':['姑表姨父','姑表姨父','表姨丈','表姨父'],
		'm,f,xs,d,s&o':['姑表姨表兄','从表兄'],
		'm,f,xs,d,s&l':['姑表姨表弟','从表弟'],
		'm,f,xs,d,d&o':['姑表姨表姐','从表姐'],
		'm,f,xs,d,d&l':['姑表姨表妹','从表妹'],
		'm,m':['外婆','外祖母','姥姥','阿婆'],
		...
		'm,xs,d&l':['姨表妹','表妹'],
		'm,xs,d&l,h':['姨表妹夫','表妹夫'],
		'm,xs,d,s':['表外甥男','表外甥','姨表甥男','表甥男'],
		'm,xs,d,s,s':['表外甥孙男'],
		'm,xs,d,s,d':['表外甥孙女'],
		'm,xs,d,d':['表外甥女','表外甥','姨表甥女','表甥女'],
		'm,xs,d,d,s':['表外甥外孙男'],
		'm,xs,d,d,d':['表外甥外孙女'],
		'm,os':['大姨','大姨妈'],
		'm,os,h':['大姨父','大姨丈'],
		...
		'w,xb,s,s':['内侄孙'],
		'w,xb,s,s,w':['内侄孙妇','内侄孙媳妇'],
		'w,xb,s,d':['内侄孙女'],
		'w,xb,s,d,h':['内侄孙女婿'],
		'w,xb,d':['内侄女','妻侄女','舅侄女','岳侄女','丈人侄女'],
		'w,xb,d,h':['内侄女婿','妻侄女婿','舅侄女婿','岳侄女婿','丈人侄女婿'],
		'w,xb,d,s':['外侄孙'],
		'w,xb,d,s,w':['外侄孙媳妇'],
		'w,xb,d,d':['外侄孙女'],
		'w,xb,d,d,h':['外侄孙女婿'],
		...
		'w,xs,s':['内甥','内甥男','妻甥男','姨甥男','岳甥男','丈人甥男'],
		'w,xs,s,w':['内甥妇','姨甥妇','姨甥妇','岳甥妇','丈人甥妇'],
		'w,xs,s,s':['内甥孙','姨甥孙'],
		'w,xs,s,s,w':['内甥孙妇','姨甥孙妇'],
		'w,xs,s,d':['内甥孙女','姨甥孙女'],
		'w,xs,s,d,h':['内甥孙女婿','姨甥孙女婿'],
		'w,xs,d':['内甥女','姨甥女','妻外甥女','丈人甥女'],
		'w,xs,d,h':['内甥婿','姨甥婿','姨甥女婿','妻甥婿','岳甥婿','丈人甥婿'],
		'w,xs,d,s':['内甥孙','姨甥孙'],
		'w,xs,d,s,w':['内甥孙媳妇','姨甥孙媳妇'],
		'w,xs,d,d':['内甥孙女','姨甥孙女'],
		'w,xs,d,d,h':['内甥孙女婿','姨甥孙女婿'],
		'w,os':['大姨子','大姨姐','大姨姊','妻姐'],
