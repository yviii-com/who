...
!function (root, factory) {
    ...
    'f,m,m,xs,d,h':['表姨祖父'],
		...
		'f,m,xs,s&l':['姨表叔父','表叔父','表叔爸','表叔'],
		'f,m,xs,s&l,w':['姨表叔母','表叔母','表叔妈','表婶'],
		'f,m,xs,s,s':['从表兄弟'],
		'f,m,xs,s,d':['从表姐妹'],
		'f,m,xs,d':['姨表姑母','表姑妈','表姑母','表姑姑','表姑'],
		'f,m,xs,d,h':['姨表姑父','表姑爸','表姑父','表姑丈'],
		'f,m,xs,d,s':['从表兄弟'],
		'f,m,xs,d,d':['从表姐妹'],
		'f,xb,s&o':['堂哥','堂兄'],
		'f,xb,s&o,w':['堂嫂'],
    ...
    'm,f,m,xs,d,h':['表姑外祖父'],
		'm,f,xb':['小姥爷','x姥爷'],
		'm,f,xb,s':['堂舅','堂舅爸','堂舅父','堂舅舅'],
		'm,f,xb,s,w':['堂舅妈','堂舅母'],
		'm,f,xb,d':['堂姨','堂姨妈','堂姨母'],
		'm,f,xb,d,h':['堂姨丈','堂姨爸','堂姨父'],
    ...
    'm,m,m,xs,d,h':['表姨外祖父'],
		...
		'm,m,xs,s':['姨表舅父','姨表舅爸','表舅父','表舅爸','表舅','表舅舅','姨表舅舅'],
		'm,m,xs,s,w':['姨表舅母','姨表舅妈','表舅母','表舅妈'],
		'm,m,xs,s,s':['从表兄弟'],
		'm,m,xs,s,d':['从表姐妹'],
		'm,m,xs,d':['姨表姨母','姨表姨妈','表姨母','表姨妈','表姨','表阿姨','姨表姨姨'],
		'm,m,xs,d,h':['姨表姨父','姨表姨丈','表姨父','表姨丈'],
		'm,m,xs,d,s':['从表兄弟'],
		'm,m,xs,d,d':['从表姐妹'],
		//舅家
