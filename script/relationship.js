...
!function (root, factory) {
    ...
    */
    ...
    var _main = {
        ...
        'm,f,ob':['伯外公','外伯公','伯外祖父','外伯祖父','伯姥爷','外伯祖','伯外祖','大外公','大姥爷','大外爷'],
        'm,f,ob,w':['伯外婆','外伯婆','伯外祖母','外伯祖母','伯姥姥','外姆婆','大外婆','大姥姥','大姥奶'],
        'm,f,lb':['叔外公','外叔公','叔外祖父','外叔祖父','叔姥爷','外叔祖','叔外祖','小外公','小姥爷','小外爷'],
        'm,f,lb,w':['叔外婆','外叔婆','叔外祖母','外叔祖母','叔姥姥','外婶婆','小外婆','小姥姥','小姥奶'],
        'm,f,xb':['x外公','x姥爷','x外爷'],
        ...
        'm':['妈妈','母亲','阿妈','老母','老妈','老娘','老乸','老妈子','妈子','娘老子','姆嬷','姆妈','妈','母','娘','娘亲','妈咪'],
        'f,ob':['伯父','伯伯','阿伯','大伯','大伯爷','大大','世父','大爹','大爸','x伯'],
        'f,ob,w':['伯母','伯妈','伯娘','阿娘','姆姆','姆','世母','大娘','大妈','大姆妈','x伯母','x妈'],
        'f,lb':['叔叔','叔父','叔爸','叔爹','阿叔','叔儿','仲父','季父','小叔','小爹','小爸','尕爸','幺爸','幺爹','幺叔','细叔','满叔','晚叔','叔','x叔'],
        ...
        'm,ob':['大舅','舅父'],
        'm,ob,w':['大舅妈','大妗'],
        'm,lb':['小舅','舅仔','舅父仔','幺舅','老舅','细舅','满舅','尕阿舅'],
        'm,lb,w':['小舅妈','小妗','细妗'],
        ...
        'h,ob':['大伯子','大伯兄'],
        'h,ob,w':['大婶子','大伯兄姊','伯嫂','大伯嫂','大伯妇','大伯娘','夫兄嫂'],
        'h,lb':['小叔子','小叔弟'],
        'h,lb,w':['小婶子','小叔弟妹','叔妇','小叔妇','小婶','夫弟妇'],
        'h,xb':['伯叔'],
        'h,xb,w':['妯娌'],
        'h,xb,s':['叔伯男','叔男','从男'],
        'h,xb,d':['叔伯女','叔女','从女'],
        ...
        'w,ob':['大舅子','大舅兄','舅兄'],
        'w,ob,w':['大舅妇','大舅兄嫂','舅嫂','大舅嫂','大舅姐','大舅媳妇','大妗子'],
        'w,lb':['小舅子','小舅弟','舅弟'],
        'w,xb':['舅子','妻舅'],
        'w,xb,w':['妻妗'],
        'w,xb,s':['舅侄男','舅男'],
        'w,xb,d':['舅侄女','舅女'],
        'w,lb,w':['小舅妇','小舅弟妇','舅弟媳','小舅妹','小舅媳妇','小妗子'],
        'w,os':['大姨子','大姨姐','姨姐'],
