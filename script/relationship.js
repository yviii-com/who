...
(function(window){
	...
	var _data = {
		...
		'f,m,f':['曾外祖父','外太公'],
		'f,m,m':['曾外祖母','外太婆'],
		'f,m,xb':['舅公','舅老爷','舅爷爷','舅爷','舅祖','舅奶爷','舅祖父'],
		'f,m,xb,w':['舅婆','舅奶奶'],
		'f,m,xb,s&o':['表伯','表伯父'],
		'f,m,xb,s&o,w':['表伯母'],
		'f,m,xb,s&l':['表叔','表叔父'],
		...
		'f,ob':['伯父','伯伯','大伯','二伯','三伯'],
		'f,ob,w':['伯母','大娘'],
		'f,lb':['叔叔','叔父','阿叔','叔','二叔','三叔'],
		'f,lb,w':['婶婶','婶母','阿婶','家婶','婶'],
		//姑家
		'f,xs':['姑妈','姑母','姑姑','姑'],
		'f,xs,h':['姑丈','姑父','姑夫'],
		'f,xs,s&o':['表哥(姑家)','表哥'],
		...
		'm,f,xb,d,h':['堂姨丈'],
		'm,f,ob':['外伯祖父','大姥爷','外伯祖'],
		'm,f,ob,w':['外伯祖母','大姥姥','外姆婆'],
		'm,f,lb':['外叔祖父','小姥爷','外叔祖'],
		'm,f,lb,w':['外叔祖母','小姥姥','外姆婆'],
		'm,f,xs':['外姑祖父','姑姥姥','外太姑母'],
		'm,f,xs,h':['外姑祖母','姑姥爷','外太姑父'],
		'm,f,xs,s':['表舅'],
		'm,f,xs,s,w':['表舅妈'],
		'm,f,xs,d':['表姨'],
		'm,f,xs,d,h':['表姨丈'],
		...
		'm,m,xb':['外舅公','外舅祖父','舅姥爷','舅外祖父','舅外公','舅爷爷','舅公'],
		'm,m,xb,w':['外舅婆','外舅祖母','舅姥姥'],
		'm,m,xb,s':['表舅'],
		'm,m,xb,s,w':['表舅妈'],
		'm,m,xb,d':['表姨'],
		'm,m,xb,d,h':['表姨丈'],
		'm,m,xs':['外姨婆','外姨祖父','姨姥姥','姨婆'],
		'm,m,xs,w':['外姨丈公','外姨祖母','姨姥爷'],
		'm,m,xs,s':['表舅'],
		'm,m,xs,s,w':['表舅妈'],
		'm,m,xs,d':['表姨'],
		'm,m,xs,d,h':['表姨丈'],
		//舅家
		'm,xb':['舅舅','舅父','舅','娘舅','舅仔','二舅','三舅'],
		'm,xb,w':['舅妈','舅母','妗妗','妗母','阿妗','二舅妈','三舅妈'],
		'm,xb,s&o':['表哥(舅家)','表哥'],
		'm,xb,s&o,w':['表嫂(舅家)','表嫂'],
		'm,xb,s&l':['表弟(舅家)','表弟'],
		...
		'm,lb,w':['小舅妈'],
		//姨家
		'm,xs':['姨妈','姨母','姨姨','姨娘','阿姨','姨','二姨','三姨'],
		'm,xs,h':['姨丈','姨夫','姨父','二姨父','三姨父'],
		'm,xs,s&o':['表哥(姨家)','表哥'],
		'm,xs,s&o,w':['表嫂(姨家)','表嫂'],
		'm,xs,s&l':['表弟(姨家)','表弟'],
