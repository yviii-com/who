...
!function (root, factory) {
    ...
    */
    ...
    var _main = {
        ...
        'f,[f,xs|m,xb],s&o':['舅姑爸','姑舅爸'],
        'f,[f,xs|m,xb],s&o,w':['舅姑姆','姑舅姆'],
        'f,[f,xs|m,xb],s&l':['舅姑爸','姑舅爸'],
        'f,[f,xs|m,xb],s&l,w':['舅姑婶','姑舅婶'],
        'f,[ob|ob,w]':['伯父母'],
        'f,[lb|lb,w]':['叔父母'],
        'f,[xs|xs,h]':['姑父母'],
        'm,[xb|xb,w]':['舅父母'],
        ...
        'm,xs,h':['姨丈','姨父','姨爸','姨爹','姨婿','姨郎','尹','x姨丈','x姨父'],
        'f,f,xb,s&o':['堂伯'],
        'f,f,xb,s&o,w':['堂伯母'],
        'f,f,xb,s&l':['堂叔'],
        'f,f,xb,s&l,w':['堂婶'],
        ...
        'd,d,d,d,h':['外曾外曾外孙女婿'],
        //亲家
        's,w,f':['亲家公','亲家父','亲家翁','姻翁'],
        's,w,m':['亲家母','亲家姆','姻姆'],
        'd,h,f':['亲家公','亲家父','亲家翁','姻翁'],
        'd,h,m':['亲家母','亲家姆','姻姆'],
    };
    /*
     * 【分支标签】 - 仅内部使用
    ...
    */
    ...
    var _branch = {
        ...
        'w,{G1W},h':['岳父','丈人','丈人爹'],
        'w,{G1},s&o':['大舅子','大舅兄','舅兄'],
        'w,{G1},s&o,w':['大舅妇','大舅兄妇','舅兄妇','舅姐','大舅姐','大妗子'],
        'w,{G1},s&l':['小舅子','小舅弟','舅弟'],
