...
!function (root, factory) {
    ...
    */
    ...
    var _main = {
        ...
        'm,m,xs':['姨外婆','姨婆','外姨丈公','外丈公','x姨姥姥'],
        'm,m,xs,h':['姨外公','姨公','x姨姥爷'],
        // 父辈
    ...
    */
    ...
    var _branch = {
        ...
        'f,{G1M}':['公','祖父','太?父','奶爷','爷爷','爷'],
        'f,{G1M},w':['婆','祖母','太?母','奶奶','奶'],
        'f,{G1W}':['婆','祖母','太?母','奶奶','奶'],
        'f,{G1W},h':['公','祖父','太?父','奶爷','爷爷','爷'],
        'm,{G1M}':['外公','外爷','外?公','外祖父','外?祖父','外太?父','姥爷','毑公','毑爷','嘎公'],
        'm,{G1M},w':['外婆','外奶','外?婆','外祖母','外?祖母','外太?母','姥姥','姥娘','姥婆','毑婆','毑毑','嘎嘎'],
        'm,{G1W}':['外婆','外奶','外?婆','外祖母','外?祖母','外太?母','姥姥','姥娘','姥婆','毑婆','毑毑','嘎嘎'],
        'm,{G1W},h':['外公','外爷','外?公','外祖父','外?祖父','外太?父','姥爷','毑公','毑爷','嘎公'],
        'f,{G1},s&o':['伯父','伯伯','伯'],
        'f,{G1},s&o,w':['伯母'],
        'f,{G1},s&l':['叔父','叔爸','叔叔','叔'],
        'f,{G1},s&l,w':['叔母','婶'],
