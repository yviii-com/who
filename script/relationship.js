...
!function (root, factory) {
    ...
    */
    ...
    var _main = {
        ...
        'm,m':['外婆','外祖母','姥姥','姥娘','姥婆','阿婆','阿嬷','阿嫲','嫲嫲','外奶','客婆','舅家婆','姥婆','毑母','毑婆','毑毑','嘎嘎','尕婆','嫏嫏','嫏娘'],
        ...
        'f,lb,w':['婶婶','婶母','婶娘','婶妈','婶爹','叔妇','阿婶','仲母','季母','小婶','小娘','小妈','尕婶','幺婶','细婶','满婶','晚婆','婶子','婶儿','家婶','叔母','叔妈','叔娘','婶'],
        'f,xb':['从父','x爸爸','x爸','x爹'],
        'f,os':['大姑','大姑妈','姑姊'],
        'f,os,h':['大姑丈','大姑父','大姑爸'],
        ...
        'm,xb,w':['舅妈','舅母','舅姆妈','舅媳妇','舅妇','舅姥','妗','妗子','妗妗','妗妈','妗娘','妗母','阿妗','妗门','妗婆仔','妗儿妈'],
        'm,os':['大姨','大姨妈'],
        'm,os,h':['大姨丈','大姨父','大姨爸'],
        ...
        'h,f,f':['祖公父','祖公','祖翁','奶公父'],
        'h,f,m':['祖婆母','祖婆','奶婆母'],
        'h,m,f':['外祖公父','毑公父','外祖公','姥公父','姥公'],
        'h,m,m':['外祖婆母','毑婆母','外祖婆','姥婆母','姥婆'],
        'h,f':['公公','公父','家公','家官','翁亲','大官','老公公','老人公','公爹','老公爹','婆父','婆爹'],
        'h,m':['婆婆','婆母','家婆','家娘','姑亲','大家','老婆婆','老人婆','婆妈','婆母娘','婆子妈'],
        'h,f,ob':['伯公父','伯公','伯翁','婆婆伯'],
        'h,f,ob,w':['伯婆母','伯婆','姆婆','伯姆','婆婆伯姆'],
        'h,f,lb':['叔公父','叔公','叔翁','叔祖','婆婆叔'],
        'h,f,lb,w':['叔婆母','叔婆','婶婆','婶婆婆','婶亲','婆婆婶子'],
        'h,f,xs':['姑婆母','姑婆','婆婆姑'],
        'h,f,xs,h':['姑公父','姑公','婆婆姑夫'],
        'h,m,xb':['舅公父','舅公'],
        'h,m,xb,w':['舅婆母','舅婆','妗婆婆'],
        'h,m,xs':['姨婆母','姨婆'],
        'h,m,xs,h':['姨公父','姨公'],
        ...
        'w,m':['岳母','丈母娘','丈姥娘','岳母娘','老干娘','老丈母','丈人娘','丈母','丈母婆','丈姥','外母','泰水','外姑','老亲娘'],
        'w':['老婆','妻子','太太','媳妇儿','媳妇','夫人','女人','婆娘','妻','内人','内子','娘子','爱妻','老太婆','婆子','老婆子','老婆仔','堂客','爱人','老伴','那口子','配偶','伴侣','伉俪','卿卿'],
        ...
        'w,xs,d,d':['姨甥外孙女','姨外孙女'],
        // 兄弟
        'ob':['哥哥','哥','胞哥','亲哥','老哥','阿哥','兄长','大佬'],
        'ob,w':['嫂子','嫂','嫂嫂','兄姊','兄嫂','兄妇','兄妻','阿嫂'],
        'lb':['弟弟','弟','胞弟','亲弟','老弟','阿弟','细佬','小弟','幺弟','细弟','满弟'],
        'lb,w':['弟妹','弟媳','弟媳妇','弟新妇'],
        '1,xb,w,xb':['叔眷兄弟'],
        '1,xb,w,xb,s':['叔眷舅男'],
        '1,xb,w,xb,d':['叔眷舅女'],
        ...
        '1,xb,d,h':['从婿'],
        // 姐妹
        'os':['姐姐','姐','胞姐','亲姐','阿姐','姊仔','家姐'],
        'os,h':['姐夫','姐丈','姐婿','姐郎','姊兄','姐夫哥','胞姐夫'],
        'ls':['妹妹','妹','胞妹','亲妹','阿妹','幺妹','细妹','满妹'],
        ...
        's,w':['儿媳','儿媳妇','儿媳妇儿','新妇','心抱','息妇','儿妇','子妇','小妇','息妇儿'],
        's,w,f':['亲家公'],
        's,w,m':['亲家母'],
        ...
        'd,h':['女婿','姑爷','女婿子','女婿儿','儿婿','子婿','息婿','小婿','郎婿','息婿儿','囝婿','东床'],
        'd,h,f':['亲家公'],
        'd,h,m':['亲家母'],
        'd,s':['外孙','外孙子','外孙儿'],
        'd,s,w':['外孙媳妇','外孙妇','外孙新妇'],
    ...
    */
    ...
    var _prefix = {
    	...
    	'{G1}':{
    		...
    		'm,m,m,xs,d,d':['三从母','三从'],
    		'f,f,f,f,xb,s,s,s':['四从父','三从堂','远堂','四从'],
    ...
    var _branch = {
        ...
        'm,{G1M}':['外祖父','外公','外爷','外?公','外?祖父','外太?父','姥爷','姥公','毑公','毑爷','毑父','嘎公'],
        'm,{G1M},w':['外祖母','外婆','外奶','外?婆','外?祖母','外太?母','姥姥','姥娘','姥婆','毑婆','毑毑','毑母','嘎嘎','嫏嫏','嫏娘','姥'],
        'm,{G1W}':['外祖母','外婆','外奶','外?婆','外?祖母','外太?母','姥姥','姥娘','姥婆','毑婆','毑毑','毑母','嘎嘎','嫏嫏','嫏娘','姥'],
        'm,{G1W},h':['外祖父','外公','外爷','外?公','外?祖父','外太?父','姥爷','姥公','毑公','毑爷','毑父','嘎公'],
        '{G1M}':['父'],
        '{G1M},w':['母'],
        '{G1W}':['母'],
        '{G1W},h':['父'],
